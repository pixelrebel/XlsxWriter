...
class Worksheet(xmlwriter.XMLwriter):
    ...
    def set_first_header(self, header='', options=None, margin=None):
        ...
        if options.get('image_left'):
            self.first_header_images.append([options.get('image_left'),
                                       options.get('image_data_left'),
                                       'LH'])

        if options.get('image_center'):
            self.first_header_images.append([options.get('image_center'),
                                       options.get('image_data_center'),
                                       'CH'])

        if options.get('image_right'):
            self.first_header_images.append([options.get('image_right'),
                                       options.get('image_data_right'),
                                       'RH'])
    ...
    def set_first_footer(self, footer='', options=None, margin=None):
        ...
        if options.get('image_left'):
            self.first_footer_images.append([options.get('image_left'),
                                       options.get('image_data_left'),
                                       'LF'])

        if options.get('image_center'):
            self.first_footer_images.append([options.get('image_center'),
                                       options.get('image_data_center'),
                                       'CF'])

        if options.get('image_right'):
            self.first_footer_images.append([options.get('image_right'),
                                       options.get('image_data_right'),
                                       'RF'])
        ...
        self.margin_first_footer = options.get('margin', 0.3)
        self.header_footer_changed = True
